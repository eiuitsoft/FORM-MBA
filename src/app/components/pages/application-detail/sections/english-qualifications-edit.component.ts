      ...
      <div class="p-6 bg-gray-50 space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-4 gap-x-6 gap-y-4">
            <div>
              <label class="block text-xs font-medium text-gray-600 mb-1"
                >{{ 'ENGLISH.SCORE_HINT' | translate }} (0-9)</label
              >
              <input
                type="text"
        ...
        <div class="pl-4" formGroupName="toefl">
          ...
          <div class="grid grid-cols-1 md:grid-cols-4 gap-x-6 gap-y-4">
            <div>
              <label class="block text-xs font-medium text-gray-600 mb-1"
                >{{ 'ENGLISH.SCORE_HINT' | translate }} (0-120)</label
              >
              <input
                type="text"
                formControlName="score"
...
export class EnglishQualificationsEditComponent {
  ...
  getEnglishEntityId(): string | undefined {
    return (
      this.formGroup?.get('ielts.id')?.value ||
      this.formGroup?.get('toefl.id')?.value ||
      this.formGroup?.get('other.id')?.value ||
      undefined
    );
  }
