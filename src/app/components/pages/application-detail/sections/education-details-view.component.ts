...
import { EducationDetails } from '@/src/app/core/models/mba/mba-application';
      ...
      <div class="p-6 bg-gray-50 space-y-6">
        ...
        <div>
          ...
          <div class="mb-4 pb-4 border-b border-gray-300 last:border-b-0">
            ...
            <button
              type="button"
              (click)="openFileManager(educationTypes.UNDERGRADUATE, i)"
              [class]="
        ...
        <div>
          ...
          <div class="mb-4 pb-4 border-b border-gray-300 last:border-b-0">
            ...
            <button
              type="button"
              (click)="openFileManager(educationTypes.POSTGRADUATE, i)"
              [class]="
...
export class EducationDetailsViewComponent {
  ...
  educationTypes = EDUCATION_LEVELS;
